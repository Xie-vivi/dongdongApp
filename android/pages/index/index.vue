	...
	<view class="container">
		...
		<view class="top-nav">
			...
			<view class="nav-right" @click="goToSearch">
				<image src="/static/follow/disc.png" class="search-image" mode="aspectFit"></image>
			</view>
		</view>
		...
		<view v-else-if="activeTab === 'discover'">
			...
			<view class="discover-post">
				<view class="discover-post-header">
					<image class="discover-post-avatar" src="/static/follow/1.png" mode="aspectFill" />
			...
			<view class="discover-post-actions">
				<view class="discover-post-action">
					<image class="discover-action-icon" src="/static/follow/5.png"></image>
					<text class="discover-action-count">21</text>
				</view>
				<view class="discover-post-action">
					<image class="discover-action-icon" src="/static/follow/6.png"></image>
					<text class="discover-action-count">2</text>
				</view>
				<view class="discover-post-action">
					<image class="discover-action-icon" src="/static/follow/7.png"></image>
			...
			<view class="discover-post">
				...
				<view class="discover-post-content">
					...
					<view class="discover-post-images">
						<image class="discover-post-img" src="/static/follow/2.png" mode="aspectFill" />
						<image class="discover-post-img" src="/static/follow/3.png" mode="aspectFill" />
						<image class="discover-post-img" src="/static/follow/4.png" mode="aspectFill" />
					</view>
					<view class="discover-post-tag">
						<text class="discover-post-tag-text">某某场</text>
					</view>
			...
			<view class="post-card" v-for="(post, index) in posts" :key="index" @click="goToPostDetail(post, index)">
				...
				<view class="post-actions">
					<view class="action-item" @click.stop="toggleLike(index)">
						<image class="action-icon" src="/static/follow/5.png" :class="{ 'liked': post.isLiked }"></image>
						<text class="action-count">{{ post.likes }}</text>
					</view>
					<view class="action-item" @click.stop="toggleStar(index)">
						<image class="action-icon" src="/static/follow/6.png" :class="{ 'starred': post.isStarred }"></image>
