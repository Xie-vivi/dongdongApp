		...
		<view class="bottom-actions">
			...
			<view class="action-buttons">
				<view class="action-btn" @click="toggleLike">
					<image src="/static/关注页/5.png" class="action-icon" mode="aspectFit" :class="{ 'liked': postData.isLiked }"></image>
					<text class="action-count">{{ postData.likeCount }}</text>
				</view>
				<view class="action-btn" @click="toggleStar">
					<image src="/static/关注页/6.png" class="action-icon" mode="aspectFit" :class="{ 'starred': postData.isStared }"></image>
					<text class="action-count">{{ postData.starCount }}</text>
				</view>
				<view class="action-btn" @click="scrollToComments">
					<image src="/static/关注页/7.png" class="action-icon" mode="aspectFit"></image>
		...
		<view class="comments-section">
			...
			<view class="comments-header">
				...
				<view class="sort-options">
					...
					<image src="/static/关注页/menu-01.png" class="sort-menu" mode="aspectFit"></image>
				</view>
			</view>
				...
				<view class="comment-item" v-for="(comment, index) in comments" :key="comment.id">
					...
					<view class="comment-actions">
						<view class="comment-like" @click="toggleCommentLike(comment.id)">
							<image src="/static/关注页/5.png" class="comment-like-icon" mode="aspectFit" :class="{ 'liked': comment.isLiked }"></image>
