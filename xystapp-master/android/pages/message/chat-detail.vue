		...
		<view class="bottom-input">
			<view class="input-wrapper">
				...
				<view class="input-icon voice-icon">
					<image src="/static/私信/1.png" class="bottom-icon-img"></image>
				</view>
				...
				<view class="input-icon emoji-icon">
					<image src="/static/私信/2.png" class="bottom-icon-img"></image>
				</view>
				
				<!-- 图片按钮 -->
				<view class="input-icon image-icon" @click="chooseImage">
					<image src="/static/私信/3.png" class="bottom-icon-img"></image>
				</view>
			</view>
		</view>
	</view>
