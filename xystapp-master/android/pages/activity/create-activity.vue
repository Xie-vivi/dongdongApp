	...
	<view class="create-activity-container">
		...
		<scroll-view class="content-area" scroll-y>
			...
			<view class="select-item" @click="selectTime">
				<image src="/static/发布活动/1.png" class="item-icon time-icon"></image>
			...
			<view class="select-item" @click="selectLocation">
				<image src="/static/发布活动/2.png" class="item-icon location-icon"></image>
			...
			<view class="select-item" @click="showFieldSelector">
				<image src="/static/发布活动/5.png" class="item-icon field-icon"></image>
			...
			<view class="select-item" @click="setMaxPeople">
				<image src="/static/发布活动/3.png" class="item-icon people-icon"></image>
			...
			<view class="select-item" @click="setSignupMode">
				<image src="/static/发布活动/4.png" class="item-icon signup-icon"></image>
